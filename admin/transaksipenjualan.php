...
<nav class="navbar navbar-default">
  <div class="">
    <ul class="nav navbar-nav">
      <li>
        <a href="index.php?halaman=keranjang">keranjang</a>
      </li>
      <li>
        <a href="index.php?halaman=checkout">pembayaran</a>
      </li>
    </ul>
  </div>
</nav>
          ...
          <td>
            <div class="form-disable">
              ...
              if ($pecahdata['stok'] == 0) {
                ...
                echo '<a class="btn btn-primary" href="index.php?halaman=jual&id='.$idpecah.'">Tersedia</a>';
              }
               ?>
            </div>
          </td>
